...
namespace cdoge
{
    class Scanner
    {
        ...
        static void _initializeKeywords()
        {
            ...
            keywords.Add("boom", TokenType.ELSE);
            keywords.Add("false", TokenType.FALSE);
            keywords.Add("somany", TokenType.FOR);
            keywords.Add("wow", TokenType.FUN);
            keywords.Add("excite", TokenType.IF);
            keywords.Add("nil", TokenType.NIL);
            keywords.Add("or", TokenType.OR);
            keywords.Add("such", TokenType.PRINT);
            keywords.Add("return", TokenType.RETURN);
            keywords.Add("super", TokenType.SUPER);
            keywords.Add("this", TokenType.THIS);
            keywords.Add("true", TokenType.TRUE);
            keywords.Add("very", TokenType.VAR);
            keywords.Add("many", TokenType.WHILE);
        ...
        private void scanToken()
        {
            ...
            switch (c)
            {
                ...
                default:
                    ...
                    {
                        Doge.error(line, "Unexpected character.");
                    }
                    break;
            }
        } //scanToken
        ...
        private void string_()
        {
            ...
            if (isAtEnd())
            {
                Doge.error(line, "Unterminated string.");
                return;
            }
